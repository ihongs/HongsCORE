...
<%!
    ...
    public void doMyAction(String unit, String func) throws HongsException {
        ...
        if ("bill".equals(unit) && "create".equals(func)) {
            ...
            Set  ids = map.keySet();
            Data mod = Data.getInstance("global/data/dining/food", "food"   );
        ...
        // 代理请求
        new ActionRunner(helper, "global/auto/" + func).doAction();
        ...
        if (rd.containsKey("items")) {
            Data data = Data.getInstance("global/data/dining/" + unit + "/item", "item");
            if ("food".equals(unit)) {
                 unit = "unit";
            }
