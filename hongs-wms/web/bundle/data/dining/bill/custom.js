...
function in_bundle_data_dining_bill_list(context) {
    // 坐标暂无查询
...
function in_bundle_data_dining_bill_info(context) {
    // 添加套餐选择列表
    var id      = H$("#id", context);
    var loadUrl = 'bundle/data/dining/item_view_list.html?unit=bill&bill_id='+id;
...
function in_bundle_data_dining_bill_form(context, formobj) {
    // 添加套餐选择列表
    var id      = H$("#id", context);
    var loadUrl = 'bundle/data/dining/item_edit_list.html?unit=bill&bill_id='+id;
