...
if(!window.HsLANG)window.HsLANG={};$.extend(window.HsLANG,{
	...
	"update.title":"修改${0}",
	"select.title":"选择${0}",
	"create.success":"创建${0|记录}成功！",
	"update.success":"成功更新了${1}个${0|记录}！",
	"delete.success":"成功删除了${1}个${0|记录}！",
	"delete.confirm":"您确定要删除这个(些){$0|记录}？",
	...
	"list.get.one":"请选择一行",
	"list.page.info": "共 ${count} 条, 分 ${total} 页",
	"list.page.unfo": "超 ${count} 条, 分 ${total} 页",
	...
	"form.required":"必须设置",
	"form.requires":"必须设置",
	"form.repeated":"值必选为列表",
	"form.ordinary":"值不可为列表",
	"form.gt.max":"不得大于$0",
	"form.lt.min":"不得小于$0",
