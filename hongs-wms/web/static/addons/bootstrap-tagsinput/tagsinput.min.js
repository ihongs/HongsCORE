 ...
 */
(function(a){if(!a.fn.tagsinput){return}a(document).on("hsReady",function(){a(this).find("[data-toggle=tagsinput]").each(function(){if(a(this).data("tagsinput")){return}a(this).tagsinput({trimValue:true,confirmKeys:[13,44,59,65292,65307]});a(this).siblings(".bootstrap-tagsinput").attr("class",a(this).attr("class")).addClass("bootstrap-tagsinput").attr("style",a(this).attr("style")).show().on("keypress",function(b){if(b.keyCode===13){b.stopPropagation();return false}});a(this).on("change",function(c){var b=a(this).data("tagsinput");a(".tag",b.$container).remove();a("option",b.$element).remove();while(b.itemsArray.length>0){b.itemsArray.pop()}b.add(a(this).val(),!0)})})})})(jQuery);
