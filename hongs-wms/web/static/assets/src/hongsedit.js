...
function setEditor(node, func) {
    ...
    forEditor(function() {
        node.each(function() {
            ...
            var conf = {
                toolbar : [
                    ['font', ['color', 'bold' , 'italic', 'underline']],
                    ['inst', ['table', 'picture', 'link', 'hr']],
...
+ '<label class="col-xs-4 text-right form-label control-label form-control-static">字体</label>'
...
+ '</div>'
+ '<div class="form-group row">'
+ '<label class="col-xs-4 text-right form-label control-label form-control-static">字号</label>'
...
+ '</div>'
+ '<div class="form-group row">'
+ '<label class="col-xs-4 text-right form-label control-label form-control-static">行高</label>'
...
+ '</div>'
+ '<div class="form-group row">'
+ '<label class="col-xs-4 text-right form-label control-label form-control-static">缩进</label>'
+ '<div class="col-xs-4"><input class="form-control" type="number" name="text-indent" value="" data-unit="em" step="0.5" min="0" max="8" ></div>'
+ '<div class="col-xs-2 form-control-static">(em)</div>'
+ '</div>'
+ '<div class="form-group row">'
+ '<label class="col-xs-4 text-right form-label control-label form-control-static">段尾间距</label>'
+ '<div class="col-xs-4"><input class="form-control" type="number" name="margin-bottom" value="" data-unit="px" step="1" min="0" max="80"></div>'
+ '<div class="col-xs-2 form-control-static">(px)</div>'
+ '</div>'
+ '<div class="form-group row">'
+ '<label class="col-xs-4 text-right form-label control-label form-control-static">文本对齐</label>'
...
+ '</div></div>'
+ '<div class="form-group row">'
+ '<label class="col-xs-4 text-right form-label control-label form-control-static">图片样式</label>'
...
+ '</div></div>'
+ '<div class="form-group row">'
+ '<label class="col-xs-4 text-right form-label control-label form-control-static">应用范围</label>'
