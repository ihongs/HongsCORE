...
jQuery.fn.hsPick=function(d,p,i,w,e){var l={};var r=i.attr("data-fn")||i.attr("name");var m=i.attr("data-ft")||i.attr("type");var x=i.attr("data-vk")||"id";var c=i.attr("data-tk")||"name";var o=i.attr("data-at");var s=i.is(".pickmul")||!!i.data("repeated")||!!i.data("multiple")||/(\[\]|\.\.|\.$)/.test(r);var u=i.closest(".HsForm").data("HsForm")||{};var f=jQuery(this);if(!w){do{w=u["_fill_"+r];if(w){break}w=u["_fill_"+m];if(w){break}w=hsFormFillPick}while(false)}if(!e){do{e=u["_fork_"+r];if(e){break}e=u["_fork_"+m];if(e){break}e=hsFormForkData}while(false)}e.call(u,i,l,r);function h(B,n,A,y){var v=jQuery.Event("pickItem");v.target=y;i.trigger(v,arguments);if(v.isDefaultPrevented()){return false}if(!s){for(var z in l){delete l[z]}if(n!==undefined){l[B]=[n,A]}b()}else{if(n!==undefined){l[B]=[n,A]}else{delete l[B]}var t=Object.keys(l).length;p.find(".picknum").text(t)}return true}function b(){var n=jQuery.Event("pickBack");n.target=p;i.trigger(n,[l,r,m]);if(n.isDefaultPrevented()){return false}p.hsClose();w.call(u,i,l,r);i.trigger("change",[l,r]);return true}function a(){var v=jQuery(this);var n=jQuery.Event("pickOpen");n.target=v;i.trigger(n,[l,r,m]);v.addClass("picksel").toggleClass("pickmul",s).on("change",".checkone",q).on("click",".commit",g).on("saveBack",".create",k);var y=Object.keys(l);var t=y.length;v.data("pickData",l);v.find(".checkone").val(y);v.find(".picknum").text(t)}function q(){var B=jQuery(this);if(B.closest(".HsList").data("HsList")._info){return}if(B.closest(".openbox").is(p)!==true){return}var D=B.prop("checked");var t=B.val();var y;var n;if(D){do{y=B.attr("title")||"";n=B.hsData();var A=B.closest("table").find("thead");var v=B.closest("tr").find("td");var C;var z;C=A.find("[data-fn='"+c+"']").index();if(C!==-1){z=v.eq(C).text()}if(z){y=z;break}C=A.find("[data-ft='"+c+"']").index();if(C!==-1){y=v.eq(C).text()}if(z){y=z;break}}while(false)}if(h(t,y,n,B)===false){return false}}function k(){var v=jQuery(this);if(v.closest(".HsList").data("HsList")._info){return}if(v.closest(".openbox").is(p)!==true){return}var t=arguments[0];var z=arguments[1];if(z.list){z=z.list[0]}else{if(z.info){z=z.info}else{if(z.id&&o){$.hsAjax({url:hsSetParam(o,x,z.id),cache:false,rsync:false,dataType:"json",complete:function(A){A=hsResponse(A);k.call(v[0],t,A)}});return}else{return}}}var y=z[x]||hsGetValue(z,x);var n=z[c]||hsGetValue(z,c);if(h(y,n,z)===false){return false}}function g(){var n=jQuery(this);if(n.closest(".HsList").data("HsList")._info){return}if(n.closest(".openbox").is(p)!==true){return}b();return false}if(p){p=p.hsOpen(d,a)}else{p=jQuery.hsOpen(d,a)}p.data("rel",f.closest(".openbox")[0]);return p};function hsFormForkData(c,b){if(c.is("input")){var e=c.val();var d=c.data();var a=c.attr("title")||c.data("name");if(e){b[e]=[a,d||{}]}}else{if(c.is("ul,ol")){c.find("li").each(function(){var k=jQuery(this);var g=k.find("input");var i=g.val();var h=g.data();var f=k.attr("title")||g.data("name");if(i){b[i]=[f,h||{}]}})}else{if(c.is("table,tbody")){c.find("tr").each(function(){var k=jQuery(this);var g=k.find("input");var i=g.val();var h=g.data();var f=k.attr("title")||g.data("name");if(i){b[i]=[f,h||{}]}})}else{c.find("input:hidden").each(function(){var g=jQuery(this);var i=g.val();var h=g.data();var f=g.attr("title")||g.data("name");if(i){b[i]=[f,h||{}]}})}}}}function hsFormFillPick(h,k,p){if(!p){p=h.data("fn")}var o=h.is(".pickrol")||!!h.data("readonly");var w=h.is(".pickmul")||!!h.data("repeated")||!!h.data("multiple")||/(\[\]|\.\.|\.$)/.test(p);var f=h.siblings("[data-toggle=hsPick],[data-toggle=hsFork]");if(f.size()===0){f=h.children("[data-toggle=hsPick],[data-toggle=hsFork]")}h.toggleClass("pickmul",w);if(this._info){var r=h.attr("data-ak")||"data";var l=this._info[r]||hsGetValue(this._info,r);if(k==l&&p==r){if(!k){return}if(!w){k=[k]}}else{if(!jQuery.isPlainObject(k)){k=l;if(!k){return}if(!w){k=[k]}}}}if(jQuery.isArray(k)){var e=h.attr("data-tk")||"name";var x=h.attr("data-vk")||"id";var d={};for(var u=0;u<k.length;u++){var s=k[u];if(!jQuery.isPlainObject(s)&&!jQuery.isArray(s)){continue}var c=s[x]||hsGetValue(s,x);var g=s[e]||hsGetValue(s,e);if(c!==undefined&&g!==undefined){d[c]=[g,s]}}k=d}else{if(!k){k={}}}function y(v,A){var i=v.data("txt");var n=v.data("cls");v.text(i);A.val("");A.attr("title","");v.attr("class",n)}function q(n,v,A,i){n.text(i);v.val(A);v.attr("title",i);n.addClass("btn-info");n.append('<span class="close pull-right">&times;</span>')}function t(A,B,i,v){var n="&times;";jQuery('<li class="'+v[0]+'"></li>').append(jQuery('<span class="'+v[1]+'"></span>')).append(jQuery('<span class="close"></span>').html(n)).append(jQuery('<span class="title"></span>').text(i)).append(jQuery('<input type="hidden">').attr("name",p).val(B)).attr("title",i).appendTo(A)}if(h.is("input")){if(!f.data("pickInited")){f.data("pickInited",1);f.data("txt",f.text());f.data("cls",f.attr("class"));f.on("click",".close",[f,h],function(i){var n=i.data[0];var v=i.data[1];var A=v.val();delete k[A];y(v,n);v.trigger("change");return false})}if(!jQuery.isEmptyObject(k)){for(var z in k){var a=k[z];var m=a[0];q(f,h,z,m)}}else{y(f,h)}}else{if(!h.data("pickInited")){h.data("pickInited",1);h.on("click",".close",[f,h],function(i){var v=i.data[0];var A=i.data[1];var n=jQuery(this).closest("li");var B=n.find("input:hidden").val();delete k[B];n.remove();v.show();A.trigger("change");return false});h.on("click","li:not([data-toggle])",[f,h],function(n){var C=n.data[0];var D=n.data[1];var B=jQuery(this).closest("li");var E=B.find("input:hidden").val();var A=D.attr("data-vk")||("id");var v=D.attr("data-href");var i=D.attr("data-target");if(v==="-"||i==="-"||n.isDefaultPrevented()){return}if(v){v=hsSetParam(v,A,E);if(!i){jQuery.hsOpen(v)}else{D.hsFind(i).hsOpen(v)}}else{if(!o&&!w){C.click()}}})}if(!jQuery.isEmptyObject(k)){if(!w){f.hide()}}else{if(!o){f.show()}}var b=[];if(h.attr("data-href")){b[0]=o?"btn btn-link":"btn btn-info";b[1]=o?"bi bi-hi-fork":"bi bi-hi-fork"}else{b[0]=o?"btn btn-text":"btn btn-info";b[1]=o?"bi bi-hi-fork":"bi bi-hi-fork"}b[0]=h.attr("data-item-class")||b[0];b[1]=h.attr("data-icon-class")||b[1];h.children().not("[data-toggle]").remove();for(var z in k){var a=k[z];var m=a[0];t(h,z,m,b)}}}function hsListFillPick(b,a,f){var c=b.closest(".picksel");var d=c.hasClass("pickmul");var e=c.data("pickData")||{};if(!d){c.find(".checkall").hide()}if(!d){HsList.prototype._fill__radio.call(this,b,a,f)}else{HsList.prototype._fill__check.call(this,b,a,f)}if(e[a]!==undefined){b.find(".checkone").prop("checked",true).change()}b.find(".checkone").data(this._info)}function hsPickListMore(c,f,d){if(f===undefined){f=100}if(d===undefined){d=0}var e=c._id_key||"id";var k=c._tt_key||"name";var b=c._url;var i=c._data;var a=jQuery('<div class="invivisible"></div>');var g=jQuery('<input type="checkbox" class="checkone" checked="checked"/>');c.context.append(a);i=hsSerialMix({},i);try{var h=1;while(h>0){if(h>d&&d>0){break}i[c.rowsKey]=f;i[c.pageKey]=h;h++;c.ajax({url:b,data:i,type:"POST",dataType:"json",funcName:"pick",async:false,cache:false,global:false,context:c,complete:function(n){n=hsResponse(n);if(!n.ok||!n.list||!n.list.length){j=0;return}for(var m=0;m<n.list.length;m++){var l=n.list[m];var o=g.clone();o.data(l);o.attr("value",l[e]);o.attr("title",l[k]);o.appendTo(a);o.trigger("change");o.remove()}}})}}finally{a.remove()}}(function(a){a(document).on("click","[data-toggle=hsPick],[data-toggle=hsFork]",function(){var b=a(this).data("href")||a(this).attr("href");var c=a(this).data("target");var d=a(this).data("result");if(c){c=a(this).hsFind(c)}if(d){d=a(this).hsFind(d)}else{d=a(this).siblings("[name],[data-fn],[data-ft]").not(".form-ignored");if(!d.size()){d=a(this).parent()}}a(this).hsPick(b,c,d);return false})})(jQuery);jQuery.fn.hsFork=jQuery.fn.hsPick;hsFormFillFork=hsFormFillPick;hsListFillFork=hsListFillPick;
(function(a){a.fn.hsPickFile=function(g,h){if(!h){return}g=a(g);var b=/^data:/.test(h)?"":decodeURIComponent(h.replace(/^.*[\/\\]/,""));if(b===""){if(this[0].filez&&this[0].filez.length){b=this[0].filez[0].name}if(this[0].files&&this[0].files.length){b=this[0].files[0].name}}var e=g.is(".pickrol")?"":"bi bi-hi-file";var c=g.is(".pickrol")?"btn btn-link":"btn btn-info";var f=a(this).after(a(this).clone().val(""));var d=a("<span></span>").text(b);var i=a('<li class="'+c+' form-control"></li>').attr("title",b).append('<span class="close pull-right">&times;</span>').append('<span class="'+e+'"></span>').append(d).append(f);g.append(i);return i};a.fn.hsFillFile=function(d,b){if(!b){return}var f=a(this);var e=/^data:/.test(b)?"":decodeURIComponent(b.replace(/^.*[\/\\]/,""));var h=f.is(".pickrol")?"":"bi bi-hi-file";var j=f.is(".pickrol")?"btn btn-link":"btn btn-info";var i=a('<input  type="hidden" />').attr("name",d).val(b);var g=a("<span></span>").text(e);var c=a('<li class="'+j+' form-control"></li>').attr("title",e).append('<span class="close pull-right">&times;</span>').append('<span class="'+h+'"></span>').append(g).append(i);f.append(c);return c};a.fn.hsPickView=function(i,b,m,j,e){if(!b){return}a(this).before(a(this).clone().val(""));i=a(i);var l=a(this);var g=/^data:/.test(b)?"":decodeURIComponent(b.replace(/^.*[\/\\]/,""));if(g===""){if(this[0].filez&&this[0].filez.length){g=this[0].filez[0].name}if(this[0].files&&this[0].files.length){g=this[0].files[0].name}}var d=a('<li class="preview"></li>').attr("title",g).css({width:m+"px",height:j+"px",overflow:"hidden"});var c;if(!e){c=function(){var k=this.width;var o=this.height;var n=a(this);n.css({top:"0px",left:"0px"});d.css({width:k+"px",height:o+"px"})}}var f=e==="pick"?a.hsPickSnap(b,m,j,c):a.hsKeepSnap(b,m,j,c);d.append(l).append(f).append('<a href="javascript:;" class="close">&times;</a>');i.append(d);return d};a.fn.hsFillView=function(g,b,n,l,e){if(!b){return}var j=a(this);var m=a('<input  type="hidden" />').attr("name",g).val(b);var i=/^data:/.test(b)?"":decodeURIComponent(b.replace(/^.*[\/\\]/,""));var d=a('<li class="preview"></li>').attr("title",i).css({width:n+"px",height:l+"px",overflow:"hidden"});var c;if(!e){c=function(){var k=this.width;var p=this.height;var o=a(this);o.css({top:"0px",left:"0px"});d.css({width:k+"px",height:p+"px"})}}var f=e==="pick"?a.hsPickSnap(b,n,l,c):a.hsKeepSnap(b,n,l,c);d.append(m).append(f).append('<a href="javascript:;" class="close">&times;</a>');j.append(d);return d};a.fn.hsReadFile=function(b){this.each(function(){var c=this;if(this.files){if(window.FileReader){a.each(this.files,function(f,e){var d=new FileReader();d.onloadend=function(g){b.call(c,e,g.target.result)};d.readAsDataURL(e)})}else{a.each(this.files,function(e,d){b.call(c,d,d.getAsDataURL())})}}else{b.call(c,null,c.value)}});return this};a.hsPickSnap=function(g,d,f,c){var e=new Image();e.onload=function(){var i=e.width;var h=e.height;var b=h*d/f;if(b>i){e.width=d;e.height=h*d/i;a(e).css("top",(((f-e.height)/2))+"px")}else{e.height=f;e.width=i*f/h;a(e).css("left",(((d-e.width)/2))+"px")}if(c){c.call(e)}};e.src=g;return a(e)};a.hsKeepSnap=function(g,d,f,c){var e=new Image();e.onload=function(){var i=e.width;var h=e.height;var b=h*d/f;if(b<i){e.width=d;e.height=h*d/i;a(e).css("top",(((f-e.height)/2))+"px")}else{e.height=f;e.width=i*f/h;a(e).css("left",(((d-e.width)/2))+"px")}if(c){c.call(e)}};e.src=g;return a(e)};a(document).on("click","[data-toggle=hsFile]",function(){var c=a(this).siblings(":file");if(!c.data("picked")){c.data("picked",1);var b=c.siblings(".pickbox");var d=c.prop("multiple");c.on("change",function(){c.hsReadFile(function(g,f){_hsSoloFile(b,false);if(d){var e=c.clone();e[0].filez=[g];e.val("");c.val("");e.hsPickFile(b,f)}else{c.hsPickFile(b,f)}})})}c.click()});a(document).on("click","[data-toggle=hsView]",function(){var f=a(this).siblings(":file");if(!f.data("picked")){f.data("picked",1);var e=f.siblings(".pickbox");var g=f.prop("multiple");var c=e.data("mode");var b=e.data("size");var d=b.split("*",2);b=d[0];d=d[1];f.on("change",function(){f.hsReadFile(function(j,i){_hsSoloFile(e,false);if(g){var h=f.clone();h[0].filez=[j];h.val("");f.val("");h.hsPickView(e,i,b,d,c)}else{f.hsPickView(e,i,b,d,c)}})})}f.click()});a(document).on("click","ul.pickbox li",function(b){var e=a(this).closest(".pickbox");if(e.siblings("[data-toggle=hsFile],[data-toggle=hsView]").size()==0){return}if(a(b.target).is(".close")){a(this).remove();e.trigger("change");_hsSoloFile(e,true);return}var d=a(this).find("input");if(d.attr("type")!="file"){var c=hsFixUri(d.val());if(c){window.open(c,"_blank")}}})})(jQuery);function _hsSoloFile(c,a){var b=c.data("fn");if(!b||c.hasClass("pickmul")){return}if(!c.data("repeated")&&!c.data("multiple")&&!/(\[\]|\.\.|\.$)/.test(b)){c.siblings("[data-toggle=hsFile],[data-toggle=hsView]").toggle(a);c.removeClass("pickmul")}else{c.addClass("pickmul")}}function hsFormFillFile(b,a,c){if(!a){return}if(!jQuery.isArray(a)){a=[a]}if(a.length){_hsSoloFile(b,false)}jQuery.each(a,function(e,d){b.hsFillFile(c,d)})}function hsFormFillView(e,c,f){if(!c){return}if(!jQuery.isArray(c)){c=[c]}if(c.length){_hsSoloFile(e,false)}var b=e.data("mode");var a=e.data("size");var d=a.split("*",2);a=d[0];d=d[1];jQuery.each(c,function(h,g){e.hsFillView(f,g,a,d,b)})};
