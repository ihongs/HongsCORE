...
yAxis:[{show:!1}]},k={series:[{data:f,type:"bar",barMaxWidth:13,itemStyle:{normal:{barBorderRadius:[4,4,0,0]}}}],xAxis:[{data:g,show:!0,type:"category"}],yAxis:[{show:!0,type:"value"}]};b={grid:{top:30,left:15,right:15,bottom:0,containLabel:!0},tooltip:{},toolbox:{show:!0,feature:{show:!0,myBar:{show:!0,icon:"M85.312 938.688H1024V1024H0V0h85.312v938.688zM256 341.312h85.312V768H256V341.312zM512 128h85.312v640H512V128z m256 213.312h85.312V768H768V341.312z",iconStyle:{borderWidth:0,color:"#666"},title:"\u67f1\u72b6\u56fe",
onclick:function(){d.setOption(k)}},myPie:{show:!0,icon:"M85.312 512a426.688 426.688 0 0 0 844.8 85.312H426.688V93.888A426.816 426.816 0 0 0 85.312 512zM512 0v512h512a512 512 0 1 1-512-512z m506.816 438.848H585.152V5.184a512.32 512.32 0 0 1 433.664 433.664z",iconStyle:{borderWidth:0,color:"#666"},title:"\u997c\u89c6\u56fe",onclick:function(){d.setOption(m)}},myTab:{show:!0,icon:"M512 1024A512 512 0 1 1 512 0a512 512 0 0 1 0 1024z m0-85.312A426.688 426.688 0 1 0 512 85.312a426.688 426.688 0 0 0 0 853.376zM320 576a64 64 0 1 1 0-128 64 64 0 0 1 0 128z m192 0a64 64 0 1 1 0-128 64 64 0 0 1 0 128z m192 0a64 64 0 1 1 0-128 64 64 0 0 1 0 128z",
iconStyle:{borderWidth:0,color:"#666"},title:"\u5bfc\u51fa",onclick:function(){c.export(a)}}}}};"pie"==a.data("plot")?$.extend(b,m):$.extend(b,k);d.resize();d.setOption(b)},setAmountChart:function(a,b){for(var c=this,d=a.data("echart"),g=[],f=[],e=[],h=[],l=[],m=0;m<b.length;m++){var k=b[m];""!=k[0]&&0!=k[2]&&(g.push(k[1]),f.push(k[2]),e.push(k[3]),h.push({value:k[2],name:k[1]}),l.push({value:k[3],name:k[1]}))}var r={series:[{radius:[0,50],data:h,type:"pie"},{radius:[60,80],data:l,type:"pie"}],xAxis:[{show:!1}],
yAxis:[{show:!1}]},n={series:[{data:f,type:"bar",barMaxWidth:13,itemStyle:{normal:{barBorderRadius:[4,4,0,0]}}},{data:e,type:"bar",barMaxWidth:13,itemStyle:{normal:{barBorderRadius:[4,4,0,0]}}}],xAxis:[{data:g,show:!0,type:"category"}],yAxis:[{show:!0,type:"value"},{show:!0,type:"value",position:"right"}]};b={grid:{top:30,left:15,right:15,bottom:0,containLabel:!0},tooltip:{},toolbox:{show:!0,feature:{show:!0,myBar:{show:!0,icon:"M85.312 938.688H1024V1024H0V0h85.312v938.688zM256 341.312h85.312V768H256V341.312zM512 128h85.312v640H512V128z m256 213.312h85.312V768H768V341.312z",
iconStyle:{borderWidth:0,color:"#666"},title:"\u67f1\u72b6\u56fe",onclick:function(){d.setOption(n)}},myPie:{show:!0,icon:"M85.312 512a426.688 426.688 0 0 0 844.8 85.312H426.688V93.888A426.816 426.816 0 0 0 85.312 512zM512 0v512h512a512 512 0 1 1-512-512z m506.816 438.848H585.152V5.184a512.32 512.32 0 0 1 433.664 433.664z",iconStyle:{borderWidth:0,color:"#666"},title:"\u997c\u89c6\u56fe",onclick:function(){d.setOption(r)}},myTab:{show:!0,icon:"M512 1024A512 512 0 1 1 512 0a512 512 0 0 1 0 1024z m0-85.312A426.688 426.688 0 1 0 512 85.312a426.688 426.688 0 0 0 0 853.376zM320 576a64 64 0 1 1 0-128 64 64 0 0 1 0 128z m192 0a64 64 0 1 1 0-128 64 64 0 0 1 0 128z m192 0a64 64 0 1 1 0-128 64 64 0 0 1 0 128z",
iconStyle:{borderWidth:0,color:"#666"},title:"\u5bfc\u51fa",onclick:function(){c.export(a)}}}}};"pie"==a.data("plot")?$.extend(b,r):$.extend(b,n);d.resize();d.setOption(b)}};jQuery.fn.hsStat=function(a){return this._hsModule(HsStat,a)};