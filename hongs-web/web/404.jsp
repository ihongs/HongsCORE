...
<html>
    ...
    <body>
        <div class="jumbotron">
            <div class="container">
                <h1>: (</h1>
                <h3><%=CoreLocale.getInstance().translate("core.error.no.found")%>! <a href="<%=request.getContextPath()%>/" style="color: #ace;"><%=CoreLocale.getInstance().translate("core.error.go.index")%></a>.</h3>
            </div>
        </div>
