...
"inherit");$(this).data("destroy",function(){$(a).summernote("destroy")})});b&&b.call(a)})},"xml")}function forMirror(a,b){hsRequires(["static/addons/codemirror/codemirror.min.css","static/addons/codemirror/codemirror.min.js"],function(){$.isArray(b)||(b=[b]);for(var c=[],e=0;e<b.length;e++)c.push("static/addons/codemirror/mode/"+b[e]+"/"+b[e]+".js");c.length?hsRequires(c,a):a()})}
