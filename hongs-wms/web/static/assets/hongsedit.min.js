...
function setEditor(a,c){forEditor(function(){a.each(function(){var a=this,d=$(this).hsData()||{},c=HsLANG.lang.replace("_","-"),f={toolbar:[["font",["color","bold","italic","fontsize"]],["para",["style","paragraph","ul","ol"]],["inst",["table","picture","link"]],["misc",["clean","codeview"]]],buttons:{clean:function(){return $.summernote.ui.button({contents:'<i class="note-icon-eraser"></i>',tooltip:$.summernote.lang[c].font.clear,click:function(){var b=$(a).summernote("code");/<\w+[^>]+>/.test(b)?
(b=b.replace(/\x3c!--[\S\s]*?--\x3e/mg,""),b=b.replace(/ (style|class)="[\S\s]*?"/mg,"")):(b=b.replace(/^/g,"<p>"),b=b.replace(/$/g,"</p>"));$(a).summernote("code",b)}}).render()}},callbacks:{onImageUpload:function(b){for(var c=new FormData,d=0;d<b.length;d++)c.append("file.",b[d]);$.ajax({url:hsFixUri(ADD_IMG_HREF),data:c,type:"POST",dataType:"json",cache:!1,contentType:!1,processData:!1,success:function(b){b=hsResponse(b);if(b.ok)for(var c=0;c<b.file.length;c++)$(a).summernote("insertImage",b.file[c])}})}},
styleTags:"p h1 h2 h3 h4 h5 h6".split(" "),colorButton:{foreColor:"#FFFFFF",backColor:"#474949"},placeholder:$(this).attr("placeholder")||"",minHeight:1*$(this).height(),maxHeight:2*$(this).height(),lang:c};$(this).summernote($.extend(f,d));$(this).siblings(".note-editor").find(".note-current-color-button").attr("data-backcolor","inherit").find("i").css("background-color","inherit");$(this).data("destroy",function(){$(a).summernote("destroy")})});c&&c.call(a)})}
function forMirror(a,c){hsRequires(["static/addons/codemirror/codemirror.min.css","static/addons/codemirror/codemirror.min.js"],function(){$.isArray(c)||(c=[c]);for(var b=[],d=0;d<c.length;d++)b.push("static/addons/codemirror/mode/"+c[d]+"/"+c[d]+".js");b.length?hsRequires(b,a):a()})}
