...
CREATE TABLE "a_master_user" (
  ...
  "ctime" INTEGER DEFAULT NULL,
  "mtime" INTEGER DEFAULT NULL,
  "rtime" INTEGER DEFAULT NULL, /* 权限最后更新时间 */
  "ptime" INTEGER DEFAULT NULL, /* 密码最后更新时间 */
  "state" SMALLINT DEFAULT '1', /* 1 正常, 2 系统, 0 删除, -1 锁定 */
  /* 扩展字段 */
  "title" VARCHAR(200) DEFAULT NULL,
  "email" VARCHAR(200) DEFAULT NULL,
  "phone" VARCHAR(200) DEFAULT NULL,
  "title_checked" SMALLINT DEFAULT '0',
