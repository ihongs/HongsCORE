 ...
 * @version 18.07.28
 */
(function(b){b.fn.hsPickFile=function(a,c){if(c){b(this).before(b(this).clone().val(""));a=b(a);c=/^data:.+\/.+,/.test(c)?"":decodeURIComponent(c.replace(/^.*[\/\\]/,""));var f=a.is(".pickrol")?"btn-link":"btn-info",e=b("<span></span>").text(c),d=b(this);c=b('<li class="btn '+f+' form-control" ></li>').attr("title",c).append('<span class="close pull-right"      >&times;</span>').append('<span class="glyphicon glyphicon-open-file"></span>').append(e).append(d);a.append(c);return c}};b.fn.hsFillFile=function(a,c){if(c){var f=b(this),e=/^data:.+\/.+,/.test(c)?"":decodeURIComponent(c.replace(/^.*[\/\\]/,"")),d=f.is(".pickrol")?"btn-link":"btn-info",k=b("<span></span>").text(e);a=b('<input  type="hidden" />').attr("name",a).val(c);e=b('<li class="btn '+d+' form-control" ></li>').attr("title",e).append('<span class="close pull-right"      >&times;</span>').append('<span class="glyphicon glyphicon-save-file"></span>').append(k).append(a);f.append(e);return e}};b.fn.hsPickView=function(a,c,f,e,d){if(c){b(this).before(b(this).clone().val(""));a=b(a);var k=b(this),g=/^data:.+\/.+,/.test(c)?"":decodeURIComponent(c.replace(/^.*[\/\\]/,"")),h=b('<li class="preview"></li>').attr("title",g).css({width:f+"px",height:e+"px",overflow:"hidden"}),l;d||(l=function(){var a=this.width,c=this.height;b(this).css({top:"0px",left:"0px"});h.css({width:a+"px",height:c+"px"})});c="pick"===d?b.hsPickSnap(c,f,e,l):b.hsKeepSnap(c,f,e,l);h.append(k).append(c).append('<a href="javascript:;" class="close">&times;</a>');a.append(h);return h}};b.fn.hsFillView=function(a,c,f,e,d){if(c){var k=b(this);a=b('<input  type="hidden" />').attr("name",a).val(c);var g=/^data:.+\/.+,/.test(c)?"":decodeURIComponent(c.replace(/^.*[\/\\]/,"")),h=b('<li class="preview"></li>').attr("title",g).css({width:f+"px",height:e+"px",overflow:"hidden"}),l;d||(l=function(){var a=this.width,c=this.height;b(this).css({top:"0px",left:"0px"});h.css({width:a+"px",height:c+"px"})});c="pick"===d?b.hsPickSnap(c,f,e,l):b.hsKeepSnap(c,f,e,l);h.append(a).append(c).append('<a href="javascript:;" class="close">&times;</a>');k.append(h);return h}};b.fn.hsReadFile=function(a){this.each(function(){var c=this;this.files?window.FileReader?b.each(this.files,function(b,e){b=new FileReader;b.onloadend=function(b){a.call(c,e,b.target.result)};b.readAsDataURL(e)}):b.each(this.files,function(b,e){a.call(c,e,e.getAsDataURL())}):a.call(c,null,c.value)});return this};b.hsPickSnap=function(a,c,f,e){var d=new Image;d.onload=function(){var a=d.width,g=d.height;g*c/f>a?(d.width=c,d.height=g*c/a,b(d).css("top",(f-d.height)/2+"px")):(d.height=f,d.width=a*f/g,b(d).css("left",(c-d.width)/2+"px"));e&&e.call(d)};d.src=a;return b(d)};b.hsKeepSnap=function(a,c,f,e){var d=new Image;d.onload=function(){var a=d.width,g=d.height;g*c/f<a?(d.width=c,d.height=g*c/a,b(d).css("top",(f-d.height)/2+"px")):(d.height=f,d.width=a*f/g,b(d).css("left",(c-d.width)/2+"px"));e&&e.call(d)};d.src=a;return b(d)};b(document).on("click","[data-toggle=hsFile]",function(){var a=b(this).siblings(":file");if(!a.data("picked")){a.data("picked",1);var c=a.siblings(".pickbox");a.on("change",function(){_hsSoloFile(c,!1);a.hsPickFile(c,a.val())})}a.click()});b(document).on("click","[data-toggle=hsView]",function(){var a=b(this).siblings(":file");if(!a.data("picked")){a.data("picked",1);var c=a.siblings(".pickbox"),f=a.prop("multiple"),e=c.data("mode"),d=c.data("size"),k=d.split("*",2);d=k[0];k=k[1];var g=b('<input type="hidden"/>').attr("name",a.attr("name"));a.on("change",function(){a.hsReadFile(function(b,l){_hsSoloFile(c,!1);if(f){var h=a.clone();h[0].filez=[b];h.val("");a.val("");h.hsPickView(c,l,d,k,e)}else a.hsPickView(c,l,d,k,e);setTimeout(function(){g.remove()},100)});c.append(g)})}a.click()});b(document).on("click","ul.pickbox li",function(a){var c=b(this).closest(".pickbox");0!=c.siblings("[data-toggle=hsFile],[data-toggle=hsView]").size()&&(b(a.target).is(".close")?(b(this).remove(),c.trigger("change"),_hsSoloFile(c,!0)):(a=b(this).find("input"),"file"!=a.attr("type")&&(a=hsFixUri(a.val()))&&window.open(a,"_blank")))})})(jQuery);function _hsSoloFile(b,a){var c=b.data("fn");c&&!b.hasClass("pickmul")&&(b.data("repeated")||/(\[\]|\.\.|\.$)/.test(c)?b.addClass("pickmul"):(b.siblings("[data-toggle=hsFile],[data-toggle=hsView]").toggle(a),b.removeClass("pickmul")))}function hsFormFillFile(b,a,c){a&&(jQuery.isArray(a)||(a=[a]),a.length&&_hsSoloFile(b,!1),jQuery.each(a,function(a,e){b.hsFillFile(c,e)}))}function hsFormFillView(b,a,c){if(a){jQuery.isArray(a)||(a=[a]);a.length&&_hsSoloFile(b,!1);var f=b.data("mode"),e=b.data("size"),d=e.split("*",2);e=d[0];d=d[1];jQuery.each(a,function(a,g){b.hsFillView(c,g,e,d,f)})}};
