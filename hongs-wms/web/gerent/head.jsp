...
<%
    ...
    NaviMap curr = NaviMap.getInstance("gerent");
...
<div class="navbar-header">
    ...
    <a class="navbar-brand" style="font-size: 15px; font-weight: bolder;" href="<%=Core.BASE_HREF%>/gerent/">
...
<script type="text/javascript">
    (function($) {
        ...
        $("#sign-out")
            .click(function() {
                $.get(hsFixUri("gerent/sign/delete.act"), function() {
                    location.assign(hsFixUri( "gerent/login.html" ));
                });
            });
        $("#user-set")
            .click(function() {
                $.hsOpen("gerent/manage/mime.html");
            });
        $("#note-msg")
            .click(function() {
                $.hsOpen("gerent/manage/note.html");
            });
    })(jQuery);
</script>
