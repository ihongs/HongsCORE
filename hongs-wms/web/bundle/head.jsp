...
<%
    ...
    NaviMap curr = NaviMap.getInstance("bundle");
...
<div class="navbar-header">
    ...
    <a class="navbar-brand" style="font-size: 15px; font-weight: bolder;" href="<%=Core.BASE_HREF%>/bundle/">
...
<script type="text/javascript">
    (function($) {
        ...
        $("#sign-out")
            .click(function() {
                $.get(hsFixUri("bundle/sign/delete.act"), function() {
                    location.assign(hsFixUri( "bundle/login.html" ));
                });
            });
        $("#user-set")
            .click(function() {
                $.hsOpen("bundle/global/mime.html");
            });
        $("#note-msg")
            .click(function() {
                $.hsOpen("bundle/global/note.html");
            });
    })(jQuery);
</script>
