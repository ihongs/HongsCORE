...
import foo.hongs.CoreRoster;
import foo.hongs.CoreRoster.Mathod;
...
import foo.hongs.action.anno.FilterInvoker;
...
public class ActionRunner {
    ...
    throws HongsException {
        ...
        // Initialize action
        if (object instanceof foo.hongs.dh.IActing) {
           ((foo.hongs.dh.IActing) object).acting(helper, this);
        }
    }
