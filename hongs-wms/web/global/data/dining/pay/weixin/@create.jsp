...
private float getPrice(String billId) throws HongsException {
    ...
    Data mod = Data.getInstance("global/data/dining/bill", "bill");
...
%>
<%
Properties conf = CoreConfig.getInstance("global/data/dining/pay");
...
String nurl   = "http://" + request.getServerName() + Core.BASE_HREF
              + "/global/data/dining/pay/weixin_notify.jsp";
