...
(function(e){function c(l,j){l=l?l:"";l=l.toString();var k=l.length;for(var m=k;m<j;m++){l="0"+l}return l}function g(j,k){j.find("[data-date]").each(function(){var l=e(this).data("date");switch(l){case"La":case"Sa":e(this).val(k.getHours()>11?1:0);break;case"LM":case"SM":e(this).val(k.getMonth());break;case"M":e(this).val(k.getMonth()+1);break;case"y":e(this).val(k.getFullYear());break;case"Sy":e(this).val(k.getFullYear()-2000);break;case"d":e(this).val(k.getDate());break;case"H":e(this).val(k.getHours());break;case"k":e(this).val(k.getHours()+1);break;case"K":e(this).val(k.getHours()%12);break;case"h":e(this).val(k.getHours()%12)+1;break;case"m":e(this).val(k.getMinutes());break;case"s":e(this).val(k.getSeconds());break;case"S":e(this).val(k.getMilliseconds());break}});return k}function a(k,l){var j=k.find("[data-date=La],[data-date=Sa]").val()=="1";k.find("[data-date]").each(function(){var m=e(this).data("date");var o=parseInt(e(this).val());if(isNaN(o)){var n;n=e(this).children().eq(0);o=parseInt(n.val());n.prop("selected",true)}switch(m){case"LM":case"SM":l.setMonth(o);break;case"M":l.setMonth(o-1);break;case"y":l.setFullYear(o);break;case"Sy":l.setFullYear(o+2000);break;case"d":l.setDate(o);break;case"H":l.setHours(o);break;case"k":l.setHours(o-1);break;case"K":l.setHours(o+(j?12:0));break;case"h":l.setHours(o+(j?11:-1));break;case"m":l.setMinutes(o);break;case"s":l.setSeconds(o);break;case"S":l.setMilliseconds(o);break}});return l}function i(k){var j=k.length;var l=k.substring(0,1);switch(l){case"a":if(j>=4){return h("La",hsGetLang("date.La"))}else{return h("Sa",hsGetLang("date.Sa"))}case"M":if(j>=4){return h("LM",hsGetLang("date.LM"))}if(j==3){return h("SM",hsGetLang("date.SM"))}else{return d("M",1,12,j)}case"y":if(j>=4){return d("y",1949,2099,j)}else{return d("Sy",0,99,j)}case"d":return d(l,1,31,j);case"H":return d(l,0,23,j);case"k":return d(l,1,24,j);case"K":return d(l,0,11,j);case"h":return d(l,1,12,j);case"m":return d(l,0,59,j);case"s":return d(l,0,59,j);case"S":return d(l,0,999,j)}}function h(l,k){var p='<select class="form-control datebox-'+l+'" data-date="'+l+'">';for(var n=k.length,o=0;o<n;o++){var m=k[o];p+='<option value="'+o+'">'+m+"</option>"}p+="</select>";return e(p)}function d(l,n,k,j){var o='<select class="form-control datebox-'+l+'" data-date="'+l+'">';for(;n<=k;n++){var m=c(n,j);o+='<option value="'+n+'">'+m+"</option>"}o+="</select>";return e(o)}function f(j){var k=e('<span class="input-group-addon"></span>');k.text(j.replace(/^'|'$/g,""));return k}function b(k){var n=e('<div class="input-group datebox"></div>');var m=/([MdyHkKhmsSa]+|[^MdyHkKhmsSa']+|'.*?')/g;var l=/^[MdyHkKhmsSa]+$/;var j;while((j=m.exec(k))!=null){j=j[0];if(l.test(j)){n.append(i(j))}else{n.append(f(j))}}n.append(f("").css("width","100%"));return n}e.fn.hsDate=function(){if(this.data("linked")){return}var j=this.data("format")||hsGetLang("datetime.format");var l=this;var k;do{k=l.siblings().filter("[data-widget=hsDate]");if(k.size()!=0){break}k=l.parent().filter("[data-widget=hsDate]");if(k.size()!=0){break}switch(j){case"time":j=hsGetLang("time.format");break;case"date":j=hsGetLang("date.format");break;case"datetime":case"":case null:j=hsGetLang("datetime.format")}l.addClass("invisible");k=b(j);k.insertBefore(l);k.find(".input-group-addon").last().css("text-align","right").html('<span class="today glyphicon glyphicon-time  "></span><span class="clear glyphicon glyphicon-remove"></span>');if(l.parent().is(".input-group")){l.before(k.contents());k.remove();k=l.parent();k.addClass("datebox")}}while(false);k.addClass("datebox");k.attr("data-widget","hsDate");k.data("linked",l);l.attr("data-toggle","hsDate");l.data("linked",k);l.trigger("change")};e.fn.hsTime=function(){if(this.data("linked")){return}var n=this;var m=this.attr("type");var l=this.data("type");var p=this.data("format");var o=this.attr("pattern");var j=this.data("offset");j=parseInt(j||0);if(!p||!o){if(m=="time"){p="HH:mm";o="\\d{1,2}:\\d{1,2}"}else{if(m=="date"){p="yyyy-MM-dd";o="\\d{2,4}-\\d{1,2}-\\d{1,2}"}else{p="yyyy-MM-ddTHH:mm";o="\\d{2,4}-\\d{1,2}-\\d{1,2}T\\d{1,2}:\\d{1,2}"}}this.data("format",p);this.attr("pattern",o);this.attr("placeholder",p)}var k=this.next("input:hidden");if(!k.size()){k=this.prev("input:hidden")}if(!k.size()){k=e('<input type="hidden" class="form-ignored"/>');k.attr("name",this.attr("name"));this.attr("name","");if(!this.index()){this.after(k)}else{this.before(k)}}this.data("linked",k);k.data("linked",this);this.on("change",function(s){var q=e(this).val();if(q==""){k.val("");return}var u=hsPrsDate(q,p);var r=u.getTime();if(isNaN(r)||0===r){k.val("");return}if(l=="timestamp"||l=="datestamp"){r=Math.floor(r/1000)}r=j+r;k.val(r);k.trigger(e.Event("change",{Date:u}))});k.on("change",function(r){var q=e(this).val();if(q==""){n.val("");return}if(r.Date){return}if(l=="timestamp"||l=="datestamp"){q=q*1000}var s=hsFmtDate(q,p);n.val(s)});if(this.val()){this.change()}else{if(k.val()){k.change()}}};e(document).on("change","[data-date=M],[data-date=SM],[data-date=LM]",function(){var l=e(this).closest(".input-group").find("[data-date=y],[data-date=Sy]").val();var k=e(this).closest(".input-group").find("[data-date=d]");var j=e(this).val();if(l<100){l+=2000}if(j==2){if((l%4==0&&l%100!=0)||(l%400==0)){k.find("option:gt(28)").prop("selected",false).hide()}else{k.find("option:gt(27)").prop("selected",false).hide()}}else{if((j<7&&j%2==0)||(j>7&&j%2==1)){k.find("option:gt(29)").prop("selected",false).hide()}else{k.find("option:gt(27)").show()}}});e(document).on("change","[data-widget=hsDate]",function(k){if(e(k.target).data("toggle")=="hsDate"){return}if(!e(this).data("linked")){return}var q,o;var n=e(this);var m=n.data("linked");var j=m.data("format");var l=m.data("type");var p=m.data("offset");var o=new Date(1970,0,1,0,0,0,0);o=a(n,o);p=parseInt(p||0);if(l=="timestamp"||l=="datestamp"){p=p*1000}o.setTime(o.getTime()+p);switch(j){case"time":j=hsGetLang("time.format");break;case"date":j=hsGetLang("date.format");break;case"datetime":j=hsGetLang("datetime.format");break;default:if(!j){j=hsGetLang("datetime.format")}}switch(l){case"time":case"date":q=o.getTime();break;case"timestamp":case"datestamp":q=o.getTime()/1000;q=Math.floor(q);break;default:q=hsFmtDate(o,j)}m.val(q);m.trigger(e.Event("change",{Date:o}))});e(document).on("change","[data-toggle=hsDate]",function(k){if(e(k.target).data("toggle")!="hsDate"){return}if(!e(this).data("linked")){return}if(k.Date){return}var o=e(this);var n=o.data("linked");var j=o.data("format");var m=o.data("type");var p=o.val();var l=parseInt(p);switch(j){case"time":j=hsGetLang("time.format");break;case"date":j=hsGetLang("date.format");break;case"datetime":j=hsGetLang("datetime.format");default:if(!j){j=hsGetLang("datetime.format")}}if(!isNaN(l)&&(m=="timestamp"||m=="datestamp")){p=l*1000}if(!p){n.find("select").val("");o.val("");return}g(n,hsPrsDate(p,j))});e(document).on("click",".datebox .today",function(){var j=e(this).closest(".datebox");var k=new Date();g(j,k);j.change()});e(document).on("click",".datebox .clear",function(){var k=e(this).closest(".datebox").find("select");var j=e(this).closest(".datebox").data("linked");k.val("");j.val("");j.change()});e(document).on("hsReady",function(){e(this).find("[data-toggle=hsDate]").each(function(){e(this).hsDate()});e(this).find("[data-toggle=hsTime]").each(function(){e(this).hsTime()})})})(jQuery);
