...
<html>
    ...
    <body>
        <div class="jumbotron">
            <div class="container">
                <h1>: (</h1>
                <h3><%=request.getParameter("msg")%>! <a href="<%=request.getContextPath()%>/medium/" style="color: #ace;">返回</a>.</h3>
            </div>
        </div>
        <nav id="footbox" class="navbar navbar-fixed-bottom">
            <div class="container">
                <blockquote><p>Copyleft &copy; 2015 黄弘. <small class="pull-right">Powered by <a href="https://github.com/ihongs/HongsCORE/" target="_blank">HongsCORE</a>, and <a href="<%=request.getContextPath()%>/static/power.html" target="_blank">others</a>.</small></p></blockquote>
            </div>
        </nav>
    </body>
</html>