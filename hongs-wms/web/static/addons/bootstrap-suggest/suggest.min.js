 ...
 */
(function(a){if(!a.fn.bsSuggest){return}a.fn.hsSuggInput=function(){a(this).each(function(){if(a(this).data("bsSuggest")){return}a(this).bsSuggest({url:a(this).data("href")})});return this};a(document).on("cursor","[data-toggle=sugginput],[data-toggle=suggest]",function(){a(this).hsSuggInput()})})(jQuery);
