 ...
 */
(function(a){if(!a.fn.bsSuggest){return}a.fn.hsSuggInput=function(){a(this).each(function(){if(a(this).data("bsSuggest")){return}var b=a(this).hsData();a(this).bsSuggest({url:b.href||null,data:{value:b.list||[]},indexId:b.indexId||0,indexKey:b.indexKey||0,idField:b.fieldId||"",keyField:b.fieldKey||"",ignorecase:hsToBool(b.ignorecase,true),autoDropup:hsToBool(b.autoDropup,true),hideOnSelect:hsToBool(b.hideOnSelect,true)})});return this};a(document).on("cursor","[data-toggle=sugginput],[data-toggle=suggest]",function(){a(this).hsSuggInput()})})(jQuery);
