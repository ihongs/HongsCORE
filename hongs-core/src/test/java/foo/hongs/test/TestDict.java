...
public class TestDict extends TestCase {
    ...
    public void testPut() {
        ...
        //foo.hongs.util.Data.print(dict);
    }
    ...
    public void testSplitKeys() {
        ...
        foo.hongs.util.Data.print(a);
        foo.hongs.util.Data.print(b);
        foo.hongs.util.Data.print(c);
