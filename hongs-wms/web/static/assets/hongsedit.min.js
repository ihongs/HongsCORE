...
a)a=b="";e[c]=a+b});for(b=0;b<d.length;b++){var f=$(d[b]).closest("p,pre,div,h1,h2,h3,h4,h5,h6,ul,ol,table,blockquote,.note-editable");if(!f.is(".note-editable")){f.css(e);var h=f.find("img");0!==h.size()&&(h.css(c),e["text-indent"]&&f.is("h1,h2,h3,h4,h5,h6,ul,ol,table")&&f.css("text-indent",""))}}}},{label:"\u53d6\u6d88",glass:"btn-default"})}}).render()}},callbacks:{onImageUpload:function(b){for(var c=new FormData,e=0;e<b.length;e++)c.append("file.",b[e]);$.ajax({url:hsFixUri(ADD_IMG_HREF),data:c,
type:"POST",dataType:"json",cache:!1,contentType:!1,processData:!1,success:function(b){b=hsResponse(b);if(b.ok)for(var c=0;c<b.file.length;c++)$(a).summernote("insertImage",b.file[c])}})}},codemirror:{mode:"text/html",htmlMode:!0,lineNumbers:!0,lineWrapping:!0},styleTags:"p h6 h5 h4 h3 h2 h1 pre blockquote".split(" "),colorButton:{foreColor:"#FFFFFF",backColor:"#474949"},placeholder:$(this).attr("placeholder")||"",minHeight:1*$(this).height(),maxHeight:2*$(this).height(),lang:f};$(this).summernote($.extend(h,
b));$(this).siblings(".note-editor").find(".note-current-color-button").attr("data-backcolor","inherit").find("i").css("background-color","inherit");$(this).data("destroy",function(){$(a).summernote("destroy")})});b&&b.call(a)})},"xml")}
function forMirror(a,b){hsRequires(["static/addons/codemirror/codemirror.min.css","static/addons/codemirror/codemirror.min.js"],function(){$.isArray(b)||(b=[b]);for(var c=[],e=0;e<b.length;e++)c.push("static/addons/codemirror/mode/"+b[e]+"/"+b[e]+".js");c.length?hsRequires(c,a):a()})}
