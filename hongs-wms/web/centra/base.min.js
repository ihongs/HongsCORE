...
'white-space:pre-line; mso-number-format:"@";');d.attr("style","height:1px; display:none; overflow:auto;");c.attr("style","margin:1px;");c.attr("class","table table-bordered table-copylist");a.find("thead:first tr").each(function(){var a=e.clone().appendTo(g);$(this).find("th").each(function(){var b=$(this);b.is(".dont-copy,._check,._admin,:hidden")||h.clone().appendTo(a).text(b.text())})});a.find("tbody:first tr").each(function(){if($(this).is(".active")){var a=e.clone().appendTo(f);$(this).find("td").each(function(){var b=
$(this);if(!b.is(".dont-copy,._check,._admin,:hidden")){var c=l.clone().appendTo(a);b.data("node")?c.html(hsTidyHtmlTags(b.data("node"))):b.data("html")?c.html(hsTidyHtmlTags(b.data("html"))):b.data("text")?c.text(b.data("text")):b.attr("title")?c.text(b.attr("title")):c.html(hsTidyHtmlTags(b.html()))}})}});b.removeClass("alert-info").addClass("alert-success");b.find(".alert-footer .btn").prop("disabled",!1);b.find(".alert-title").text("\u5df2\u7ecf\u5907\u597d\u5217\u8868\u539f\u59cb\u6570\u636e, \u8bf7\u590d\u5236\u5427!")}else $.hsWarn("\u6d4f\u89c8\u5668\u65e0\u6cd5\u590d\u5236\r\n\u8bf7\u4f7f\u7528\u8f83\u65b0\u7248\u7684 Chrome/Safari/Firefox, \u6216\u67d0\u4e9b\u53cc\u6838/\u591a\u6838\u6d4f\u89c8\u5668\u7684\u6781\u901f\u6a21\u5f0f.",
